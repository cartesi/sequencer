...
| Adopting the sequencer in an application, in any language | [App-developer guide](docs/app-developers/README.md) — plain-language map of the contracts above for application authors; the protocol documents remain the owners. |
