...
use super::sql::{
    ...
    sql_select_latest_frame_in_batch_for_batch, sql_select_max_safe_input_index,
    ...
    sql_select_safe_block, sql_select_safe_inputs_range, sql_select_total_drained_direct_inputs,
