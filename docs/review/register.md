...
7. **Closed** (2026-09-16): mandatory era/generation/application-count claims
   ...
   generation bump. See the [history contract](../protocol/application-history.md).
...
- **Application-only current history** (2026-09-16): retain every raw L1 input
  ...
  model lives in [application history](../protocol/application-history.md), I5–I11,
